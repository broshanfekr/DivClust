...
def cifar10_test_cc(dataset_path=None, crop_size=224, *args, **kwargs):
    data, labels = dataset_readers.get_cifar10(dataset_path, ["val"])
    train_dataset, val_dataset = _get_cc_datasets(data, labels, crop_size, blur=False)
    return train_dataset, val_dataset
...
def fashion_mnist(dataset_path=None, crop_size=224, *args, **kwargs):
    data, labels = dataset_readers.get_fashion_mnist(dataset_path, ["val"])
    train_dataset, val_dataset = _get_cc_datasets(data, labels, crop_size, blur=False)
    return train_dataset, val_dataset    
